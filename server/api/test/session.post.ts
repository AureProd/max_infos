 ...
 * d'autorisations doit pouvoir se présenter comme `editor` puis comme
 ...
 *
 *  1. Le bundle. `nitro.ignore` retire tout server/api/test/ de la
 ...
 *
 * Un seul verrou suffirait ; deux protègent d'une erreur sur l'un des deux.
 */
