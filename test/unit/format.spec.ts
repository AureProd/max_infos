...
describe('frShort', () => {
  it('shortens the month to four letters', () => {
...
describe('nb', () => {
  ...
  it('ALWAYS produces the same byte, whatever the ICU version', () => {
